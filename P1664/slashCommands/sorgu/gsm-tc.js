...
module.exports = {
    ...
    interaction.user.send({ content: `:tada: ${adx} numaraya ait bilgiyi buldum. \n ${datam}`})
    // message.guild.channels.cache.get('1089132325733945444').send(`${message.author.tag} tarafından ${isim} ${soyisim} kişisi sorgulandı.`)
              }); 
            }
}