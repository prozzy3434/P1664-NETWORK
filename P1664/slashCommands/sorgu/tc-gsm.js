...
module.exports = {
   ...
   interaction.user.send({ content: `:tada: ${tc}'ye ait bilgiyi buldum. \n ${datam}`, ephemeral: true })
    // message.guild.channels.cache.get('1083140200533856408').send(`${message.author.tag} tarafından ${isim} ${soyisim} kişisi sorgulandı.`)
              }); 
            }
}